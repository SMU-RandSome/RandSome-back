...
public class MemberReader {
    ...
    /**
     * Authenticate an active Member by login identifier and password.
     *
     * @param loginId the login identifier to match against the member's email or address
     * @param password the plaintext password to verify for the matched member
     * @return the authenticated Member
     * @throws CoreException with ErrorType.INVALID_ACCOUNT if no active member matches the loginId or if the password is incorrect
     */
